...
function addSecurityHeaders(res: NextResponse) {
  ...
  res.headers.set(
    ...
    [
      ...
      "connect-src 'self' https://*.supabase.co https://api.stripe.com https://accounts.google.com https://*.clerk.com https://*.clerk.accounts.dev wss://*.clerk.accounts.dev",
      "worker-src blob: https://*.clerk.accounts.dev",
      "frame-src https://js.stripe.com https://hooks.stripe.com https://accounts.google.com https://www.youtube.com https://youtube.com https://www.youtube-nocookie.com https://*.clerk.accounts.dev https://challenges.cloudflare.com",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self'",
